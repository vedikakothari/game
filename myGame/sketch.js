...
function preload(){
  ...
  obstacleIMG = loadAnimation("images/obstacles/obstacle2/ob21.png","images/obstacles/obstacle2/ob22.png","images/obstacles/obstacle2/ob23.png","images/obstacles/obstacle2/ob24.png")
...
function spawnObstacle2(){
  if(frameCount % 130 === 0) {
    var obstacle2 = createSprite(windowWidth + 1500,1075,1000,1000);
